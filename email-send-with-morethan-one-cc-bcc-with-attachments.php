...
// Attachments
$mail->addAttachment('path/to/attachment1.pdf', 'Attachment1.pdf'); // Replace with the path to your attachment
$mail->addAttachment('path/to/attachment2.jpg', 'Attachment2.jpg'); // Add more attachments as needed

// Content
$mail->isHTML(true); // Set email format to HTML
$mail->Subject = 'Test Email From MDS Trackmate with Attachments';
$mail->Body    = 'This email has attachments.';
